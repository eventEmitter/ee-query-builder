        ...
        */
        ...
        , _renderFilter: function(query, filter, property, entity, dontEscape) {
            ...
            switch (type(filter)) {
                ...
                default:
                    // lloks like we're getting way too often to this point
                    // hence we eed to print a shitload of debug info
                    ...
                    throw new Error('Cannot process the type «'+type(filter)+'» in the querybuilder!').setName('InvalidTypeException');
            }
        }
