            ...
            order.forEach(function(instruction){
                switch (type(instruction)) {
                    ...
                    case 'object':
                        ...
                        if (instruction.entity) instructions.push(this.escapeId(instruction.entity)+'.'+this.escapeId(instruction.property) + (instruction.desc ? ' DESC' : ' ASC'));
